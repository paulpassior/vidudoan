    ...
    <body>
        ...
        <div id="middle_side" class="col-lg-5">
            ...
            <div id="announce_area_2">
                ...
                <p>Sắp đến lượt khám của quý khách. Mong quý khách đến bệnh viện đúng giờ.</p>
            </div>
            <div id="announce_area">
                <div id="announce_box">
                    <p>22 giờ 01 phút, 03 tháng 12, 2019</p>
                    <p>Quý khách đã được chuyển đến khoa <span class="exam_department">Chấn thương chỉnh hình</span> do Y tá Trịnh A</p>
                </div>
            </div>
        </div>
